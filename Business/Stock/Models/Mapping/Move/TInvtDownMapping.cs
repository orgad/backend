...
{
    public class TInvtDownMapping : IEntityTypeConfiguration<TInvtDown>
    {
        public void Configure(EntityTypeBuilder<TInvtDown> entity)
        {
            entity.ToTable("t_invt_down");
                ...
                entity.Property(e=>e.Id).HasColumnName("h_id");
                ...
                entity.Property(e => e.Code)
                    .HasColumnName("code")
                    .HasColumnType("varchar(30)")
                    .HasComment("下架记录号，与任务表的code相同。补货下架去补货任务的code，移货下架取移货任务的code")
                    .HasCharSet("utf8mb4")
                    .HasCollation("utf8mb4_0900_ai_ci");
