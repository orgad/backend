...
{
    public class TInvtFreezeDMapping : IEntityTypeConfiguration<TInvtFreezeD>
    {
        public void Configure(EntityTypeBuilder<TInvtFreezeD> entity)
        {
            entity.ToTable("t_invt_freeze_d");
